...
user8 = User.create!(email: 'henrique@teacher', password: '123123', first_name: 'Henrique Teacher', last_name: 'Marques', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user9 = User.create!(email: 'afonso@teacher', password: '123123', first_name: 'Afonso Teacher', last_name: 'Garcia', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user10 = User.create!(email: 'alecio@teacher', password: '123123', first_name: 'Alecio Teacher', last_name: 'Filho', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user11 = User.create!(email: 'breno@teacher', password: '123123', first_name: 'Breno Teacher', last_name: 'Silva', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user12 = User.create!(email: 'felipe@teacher', password: '123123', first_name: 'Felipe Teacher', last_name: 'Kummer', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user13 = User.create!(email: 'fernanda@teacher', password: '123123', first_name: 'Fernanda Teacher', last_name: 'Yamamoto', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user14 = User.create!(email: 'milena@teacher', password: '123123', first_name: 'Milena Teacher', last_name: 'Domingues', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user15 = User.create!(email: 'raquel@teacher', password: '123123', first_name: 'Raquel Teacher', last_name: 'Ciusz', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user16 = User.create!(email: 'renoir@teacher', password: '123123', first_name: 'Renoir Teacher', last_name: 'Lucena', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user17 = User.create!(email: 'tais@teacher', password: '123123', first_name: 'Tais Teacher', last_name: 'Pereira', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user18 = User.create!(email: 'laura@teacher', password: '123123', first_name: 'Laura Teacher', last_name: 'Amaro', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user19 = User.create!(email: 'patricia@teacher', password: '123123', first_name: 'Patricia Teacher', last_name: 'Kihara', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
...
user20 = User.create!(email: 'fabio@teacher', password: '123123', first_name: 'Fabio Teacher', last_name: 'Gardinal', about: Faker::Lorem.paragraph(sentence_count: 10, supplemental: true, random_sentences_to_add: 2))
