...
user2 = User.create!(email: 'rodolfo@teacher', password: '123123', first_name: 'Rodolfo', last_name: 'Campos', about: "I graduated in business and law and pursued a career working in both areas, mostly in banking and M&A. I am very excited about learning new skills and becoming more entrepreneurial.")
...
user9 = User.create!(email: 'afonso@teacher', password: '123123', first_name: 'Afonso', last_name: 'Garcia', about: "Graduated in Business Administration from PUC-Rio. First I worked as an intern at Globo and then I migrated to IBM, more precisely to the BT/IT area, where I was promoted first to Analyst and then to Application Owner, responsible for ensuring the control and security of some of the company's applications.")
...
user18 = User.create!(email: 'laura@teacher', password: '123123', first_name: 'Laura', last_name: 'Amaro', about: "I´m a IT geek, I hope that I can help you with my knowledge. I have been working with coding since I am 15 years old. I have a good background in the field.")
...
user19 = User.create!(email: 'patricia@teacher', password: '123123', first_name: 'Patricia', last_name: 'Kihara', about: "I am a driven-passionate person that loves technology. I can help you to solve your code programs, I took some courses in Ruby, Javascript and Node.js. I am pretty sure that we can do a nice job together!")
